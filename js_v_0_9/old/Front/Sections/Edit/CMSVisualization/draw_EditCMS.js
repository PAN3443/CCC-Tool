...
function drawEditCMSVIS(tmpCMS, markedKeysArray){
  ...
  if(tmpCMS.getKeyLength()==0){
    ...
    for (var i = 0; i < tmpCMS.getKeyLength()-1; i++) {
        ...
        var elementwidth = Math.round((tmpCMS.getRefPosition(i+1) - tmpCMS.getRefPosition(i)) / (tmpCMS.getRefPosition(tmpCMS.getKeyLength()-1) - tmpCMS.getRefPosition(0)) * editCMS_cmsArea_width);

        switch (tmpCMS.getKeyType(i)) {
          case "nil key": case "left key":
            // Draw Linear Colormap
            canvasData = createConstantBand(canvasData,linearKey_xPos, editCMS_linearCMS_y1, elementwidth, editCMS_linearCMS_height, tmpCMS.getLeftKeyColor(i+1,tmpCMS.getInterpolationSpace()), canvasObject.width);
            canvasData = createConstantBand(canvasData,currentSktech_xPos, editCMS_sketchCMS_y1, sketch_BandWidth, editCMS_sketchCMS_height, tmpCMS.getLeftKeyColor(i+1,tmpCMS.getInterpolationSpace()), canvasObject.width);
            break;
          default:
            ...
            if((tmpCMS.getInterpolationSpace()==="de94-ds" || tmpCMS.getInterpolationSpace()==="de2000-ds" || tmpCMS.getInterpolationType()==="spline") && tmpCMS.getIntervalLength(i)>0){
              ...
              elementwidth = Math.round((tmpCMS.getIntervalRef(i,0) - tmpCMS.getRefPosition(i)) / (tmpCMS.getRefPosition(tmpCMS.getKeyLength()-1) - tmpCMS.getRefPosition(0)) * editCMS_cmsArea_width);
              canvasData = createScaledBand(canvasData,linearKey_Sub_xPos, editCMS_linearCMS_y1, elementwidth, editCMS_linearCMS_height, tmpCMS.getRightKeyColor(i,tmpCMS.getInterpolationSpace()), tmpCMS.getIntervalColor(i,0,tmpCMS.getInterpolationSpace()), canvasObject.width);
              canvasData = createScaledBand(canvasData,currentSktech_SubxPos, editCMS_sketchCMS_y1, sketch_SubBandWidth, editCMS_sketchCMS_height, tmpCMS.getRightKeyColor(i,tmpCMS.getInterpolationSpace()), tmpCMS.getIntervalColor(i,0,tmpCMS.getInterpolationSpace()), canvasObject.width);
              currentSktech_SubxPos+=sketch_SubBandWidth;
              // between intervals
              for (var j = 0; j < tmpCMS.getIntervalLength(i)-1; j++) {
                linearKey_Sub_xPos += elementwidth;
                elementwidth = Math.round((tmpCMS.getIntervalRef(i,j+1) - tmpCMS.getIntervalRef(i,j)) / (tmpCMS.getRefPosition(tmpCMS.getKeyLength()-1) - tmpCMS.getRefPosition(0)) * editCMS_cmsArea_width);
                canvasData = createScaledBand(canvasData,linearKey_Sub_xPos, editCMS_linearCMS_y1, elementwidth, editCMS_linearCMS_height, tmpCMS.getIntervalColor(i,j,tmpCMS.getInterpolationSpace()), tmpCMS.getIntervalColor(i,j+1,tmpCMS.getInterpolationSpace()), canvasObject.width);
                canvasData = createScaledBand(canvasData,currentSktech_SubxPos, editCMS_sketchCMS_y1, sketch_SubBandWidth, editCMS_sketchCMS_height, tmpCMS.getIntervalColor(i,j,tmpCMS.getInterpolationSpace()), tmpCMS.getIntervalColor(i,j+1,tmpCMS.getInterpolationSpace()), canvasObject.width);
                currentSktech_SubxPos+=sketch_SubBandWidth;
              }
              // from last interval to last key
              linearKey_Sub_xPos += elementwidth;//editCMS_cmsArea_x1+Math.round((tmpCMS.getIntervalRef(i,j) - tmpCMS.getRefPosition(0)) / (tmpCMS.getRefPosition(tmpCMS.getKeyLength()-1) - tmpCMS.getRefPosition(0)) * editCMS_cmsArea_width);
              var tmpEndPos = editCMS_cmsArea_x1+Math.round((tmpCMS.getRefPosition(i+1) - tmpCMS.getRefPosition(0)) / (tmpCMS.getRefPosition(tmpCMS.getKeyLength()-1) - tmpCMS.getRefPosition(0)) * editCMS_cmsArea_width);
              elementwidth = (tmpEndPos-linearKey_Sub_xPos);
              sketch_SubBandWidth = (currentSktech_xPos+sketch_BandWidth-currentSktech_SubxPos);
              canvasData = createScaledBand(canvasData,linearKey_Sub_xPos, editCMS_linearCMS_y1, elementwidth, editCMS_linearCMS_height, tmpCMS.getIntervalColor(i,tmpCMS.getIntervalLength(i)-1,tmpCMS.getInterpolationSpace()), tmpCMS.getLeftKeyColor(i+1,tmpCMS.getInterpolationSpace()), canvasObject.width);
              canvasData = createScaledBand(canvasData,currentSktech_SubxPos, editCMS_sketchCMS_y1, sketch_SubBandWidth, editCMS_sketchCMS_height, tmpCMS.getIntervalColor(i,tmpCMS.getIntervalLength(i)-1,tmpCMS.getInterpolationSpace()), tmpCMS.getLeftKeyColor(i+1,tmpCMS.getInterpolationSpace()), canvasObject.width);
            }
            else {
              canvasData = createScaledBand(canvasData,linearKey_xPos, editCMS_linearCMS_y1, elementwidth, editCMS_linearCMS_height, tmpCMS.getRightKeyColor(i,tmpCMS.getInterpolationSpace()), tmpCMS.getLeftKeyColor(i+1,tmpCMS.getInterpolationSpace()), canvasObject.width);
              canvasData = createScaledBand(canvasData,currentSktech_xPos, editCMS_sketchCMS_y1, sketch_BandWidth, editCMS_sketchCMS_height, tmpCMS.getRightKeyColor(i,tmpCMS.getInterpolationSpace()), tmpCMS.getLeftKeyColor(i+1,tmpCMS.getInterpolationSpace()), canvasObject.width);
            }
