...
class class_TestField {
  ...
  deleteReferences(){
    delete this.dimensionX;
    delete this.dimensionY;
    delete this.fieldValues ;
    delete this.xPos;
    delete this.yPos;
    delete this.cellValue;
    /*delete this.xmax = -Infinity;
    delete this.xmin = Infinity;
    delete this.ymax = -Infinity;
    delete this.ymin = Infinity;*/
    delete this.vmax;
    delete this.vmin;
    delete this.vdis;
    delete this.doAutoScale;
    delete this.scaleRangeMin;
    delete this.scaleRangeMax;
    delete this.scaleRangeDis;

    delete this.noiseValues;
    delete this.addNoise;
    delete this.noiseBehavior;
    delete this.noiseMaxChange;
    delete this.replaceNoiseFrom;
    delete this.replaceNoiseTill;
