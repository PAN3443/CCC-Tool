class class_Element_TestReport extends class_Testing_Element_Basis {
  ...
  constructor(divID,buttonID) {
    ...
    this.worker_testreport = new Worker("../../"+version_JS_FolderName+"/src/CCC/sections/test_functions/worker/worker_ReportTesting.js"); //, { type: "module" });
            ...
            switch(this.mousePosY) {
              case 0:
                // left bottom corner
                  ...
                  tableInfo[1] = [this.valueDifInfo[1][this.mousePosX][this.mousePosY],this.valueRatioInfo[1][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[1][this.mousePosX][this.mousePosY],"rgb"),this.colorDifInfo[1][this.mousePosX][this.mousePosY],this.colorRatioInfo[1][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[1][this.mousePosX][this.mousePosY],"rgb"),this.ratioInfo[1][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[1][this.mousePosX][this.mousePosY],"rgb"),false,false,false];
                  tableInfo[2] = [this.valueDifInfo[2][this.mousePosX][this.mousePosY],this.valueRatioInfo[2][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[2][this.mousePosX][this.mousePosY],"rgb"),this.colorDifInfo[2][this.mousePosX][this.mousePosY],this.colorRatioInfo[2][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[2][this.mousePosX][this.mousePosY],"rgb"),this.ratioInfo[2][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[2][this.mousePosX][this.mousePosY],"rgb"),false,false,false];
                  tableInfo[4] = [this.valueDifInfo[0][this.mousePosX][this.mousePosY],this.valueRatioInfo[0][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[0][this.mousePosX][this.mousePosY],"rgb"),this.colorDifInfo[0][this.mousePosX][this.mousePosY],this.colorRatioInfo[0][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[0][this.mousePosX][this.mousePosY],"rgb"),this.ratioInfo[0][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[0][this.mousePosX][this.mousePosY],"rgb"),false,false,false];
                ...
                case this.reportListTestField[selectedIndex][0].length-1:
                    ...
                    tableInfo[4] = [this.valueDifInfo[0][this.mousePosX][this.mousePosY],this.valueRatioInfo[0][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[0][this.mousePosX][this.mousePosY],"rgb"),this.colorDifInfo[0][this.mousePosX][this.mousePosY],this.colorRatioInfo[0][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[0][this.mousePosX][this.mousePosY],"rgb"),this.ratioInfo[0][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[0][this.mousePosX][this.mousePosY],"rgb"),false,false,false];
                    tableInfo[6] = [this.valueDifInfo[1][this.mousePosX][this.mousePosY-1],this.valueRatioInfo[1][this.mousePosX][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[1][this.mousePosX][this.mousePosY-1],"rgb"),this.colorDifInfo[1][this.mousePosX][this.mousePosY-1],this.colorRatioInfo[1][this.mousePosX][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[1][this.mousePosX][this.mousePosY-1],"rgb"),this.ratioInfo[1][this.mousePosX][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[1][this.mousePosX][this.mousePosY-1],"rgb"),false,false,false];
                    tableInfo[7] = [this.valueDifInfo[3][this.mousePosX][this.mousePosY-1],this.valueRatioInfo[3][this.mousePosX][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[3][this.mousePosX][this.mousePosY-1],"rgb"),this.colorDifInfo[3][this.mousePosX][this.mousePosY-1],this.colorRatioInfo[3][this.mousePosX][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[3][this.mousePosX][this.mousePosY-1],"rgb"),this.ratioInfo[3][this.mousePosX][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[3][this.mousePosX][this.mousePosY-1],"rgb"),false,false,false];
                  break;
              default:
                  // left side
          ...
          case this.reportListTestField[selectedIndex].length-1:
              ...
              switch(this.mousePosY) {
                case 0:
                  ...
                  tableInfo[0] = [this.valueDifInfo[3][this.mousePosX-1][this.mousePosY],this.valueRatioInfo[3][this.mousePosX-1][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[3][this.mousePosX-1][this.mousePosY],"rgb"),this.colorDifInfo[3][this.mousePosX-1][this.mousePosY],this.colorRatioInfo[3][this.mousePosX-1][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[3][this.mousePosX-1][this.mousePosY],"rgb"),this.ratioInfo[3][this.mousePosX-1][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[3][this.mousePosX-1][this.mousePosY],"rgb"),false,false,false];
                  tableInfo[1] = [this.valueDifInfo[1][this.mousePosX][this.mousePosY],this.valueRatioInfo[1][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[1][this.mousePosX][this.mousePosY],"rgb"),this.colorDifInfo[1][this.mousePosX][this.mousePosY],this.colorRatioInfo[1][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[1][this.mousePosX][this.mousePosY],"rgb"),this.ratioInfo[1][this.mousePosX][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[1][this.mousePosX][this.mousePosY],"rgb"),false,false,false];
                  tableInfo[3] = [this.valueDifInfo[0][this.mousePosX-1][this.mousePosY],this.valueRatioInfo[0][this.mousePosX-1][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[0][this.mousePosX-1][this.mousePosY],"rgb"),this.colorDifInfo[0][this.mousePosX-1][this.mousePosY],this.colorRatioInfo[0][this.mousePosX-1][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[0][this.mousePosX-1][this.mousePosY],"rgb"),this.ratioInfo[0][this.mousePosX-1][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[0][this.mousePosX-1][this.mousePosY],"rgb"),false,false,false];
                  break;
                  case this.reportListTestField[selectedIndex][0].length-1:
                    //  right top corner
                    ...
                    tableInfo[3] = [this.valueDifInfo[0][this.mousePosX-1][this.mousePosY],this.valueRatioInfo[0][this.mousePosX-1][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[0][this.mousePosX-1][this.mousePosY],"rgb"),this.colorDifInfo[0][this.mousePosX-1][this.mousePosY],this.colorRatioInfo[0][this.mousePosX-1][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[0][this.mousePosX-1][this.mousePosY],"rgb"),this.ratioInfo[0][this.mousePosX-1][this.mousePosY],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[0][this.mousePosX-1][this.mousePosY],"rgb"),false,false,false];
                    tableInfo[5] = [this.valueDifInfo[2][this.mousePosX-1][this.mousePosY-1],this.valueRatioInfo[2][this.mousePosX-1][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[2][this.mousePosX-1][this.mousePosY-1],"rgb"),this.colorDifInfo[2][this.mousePosX-1][this.mousePosY-1],this.colorRatioInfo[2][this.mousePosX-1][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[2][this.mousePosX-1][this.mousePosY-1],"rgb"),this.ratioInfo[2][this.mousePosX-1][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[2][this.mousePosX-1][this.mousePosY-1],"rgb"),false,false,false];
                    tableInfo[6] = [this.valueDifInfo[1][this.mousePosX][this.mousePosY-1],this.valueRatioInfo[1][this.mousePosX][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.valueRatioInfo[1][this.mousePosX][this.mousePosY-1],"rgb"),this.colorDifInfo[1][this.mousePosX][this.mousePosY-1],this.colorRatioInfo[1][this.mousePosX][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.colorRatioInfo[1][this.mousePosX][this.mousePosY-1],"rgb"),this.ratioInfo[1][this.mousePosX][this.mousePosY-1],this.reportColorValueDifColormap.calculateColor(this.ratioInfo[1][this.mousePosX][this.mousePosY-1],"rgb"),false,false,false];
                    break;
                default:
                  // right sieht
