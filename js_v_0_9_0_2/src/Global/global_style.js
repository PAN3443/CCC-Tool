...
function updateToolVersion(){
  document.getElementById("id_footer_version").innerHTML= "Version: "+tool_version;
  document.getElementById("id_footer_copyRight").innerHTML= "Copyright © "+tool_copyRight;
}
