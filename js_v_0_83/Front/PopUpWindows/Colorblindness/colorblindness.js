...
function updateEditPage_ColorBlindness() {
  ...
  function updateColorBlindness_TransferMatrices() {
    ...
    rgbWhiteOrigin.deleteReferences();
    rgbBluePrimary.deleteReferences();
    rgbRedPrimary.deleteReferences();

    xyzWhiteOrigin.deleteReferences();
    xyzBluePrimary.deleteReferences();
    xyzRedPrimary.deleteReferences();

    lmsWhiteOrigin.deleteReferences();
    lmsBluePrimary.deleteReferences();
    lmsRedPrimary.deleteReferences();
