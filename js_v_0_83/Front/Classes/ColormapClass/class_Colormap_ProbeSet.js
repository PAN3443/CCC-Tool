...
class class_ProbeSet{
      ...
      deleteReferences(){
        delete this.name;
        for (var i = this.probeArray.length-1; i >=0 ; i--) {
          this.probeArray[i].deleteReferences();
          this.probeArray[i]=null;
        }
        delete this.probeArray;
        delete this.currentKey;
      }


      deleteProbe(index){
        this.probeArray[index].deleteReferences();
        this.probeArray[index]=null;
