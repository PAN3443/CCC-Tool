    ...
    for (var i = 0; i < globalCMS1.getKeyLength(); i++) {
      ...
      switch (globalCMS1.getKeyType(i)) {
        ...
        case "twin key":
            ...
            ////////////////////////////////////////////////////////////////
            /////// left Color
            pathplotElementPositions.push(calcRGBElementPos(globalCMS1.getLeftKeyColor(i, "rgb"),drawCircle,areaDim,i,0));

            ////////////////////////////////////////////////////////////////
            /////// Right Color
            pathplotElementPositions.push(calcRGBElementPos(globalCMS1.getRightKeyColor(i, "rgb"),true,areaDim,i,1));
        ...
        default:
            // dual Key
            pathplotElementPositions.push(calcRGBElementPos(globalCMS1.getRightKeyColor(i, "rgb"),true,areaDim,i,2));
      }
  ...
  for (var i = 0; i < globalCMS1.getKeyLength(); i++) {
    ...
    switch (globalCMS1.getKeyType(i)) {
      ...
      case "twin key":
        ...
        ////////////////////////////////////////////////////////////////
        /////// left Color
        pathplotElementPositions.push(calcHSV_Hue_ElementPos(globalCMS1.getLeftKeyColor(i, "hsv"),drawCircle,i,0));

        ////////////////////////////////////////////////////////////////
        /////// Right Color
        pathplotElementPositions.push(calcHSV_Hue_ElementPos(globalCMS1.getRightKeyColor(i, "hsv"),true,i,1));

        ////////////////////////////////////////////////////////////////
        /////// V Plot

        if (drawCircle) {
          vPlotElementPositions.push(calcHSV_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "hsv"),true,i,0,i));
          vPlotElementPositions.push(calcHSV_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "hsv"),true,i,1,i));
        } else {
          vPlotElementPositions.push(calcHSV_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "hsv"),drawCircle,i,0,(i - 1)));
          vPlotElementPositions.push(calcHSV_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "hsv"),drawCircle,i,0,i));
          vPlotElementPositions.push(calcHSV_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "hsv"),true,i,1,i));
        }
      ...
      default:
        ...
        pathplotElementPositions.push(calcHSV_Hue_ElementPos(globalCMS1.getRightKeyColor(i, "hsv"),true,i,2));

        ////////////////////////////////////////////////////////////////
        /////// V Plot

        vPlotElementPositions.push(calcHSV_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "hsv"),true,i,2,i));

        if(globalCMS1.getKeyType(i-1)==="left key"){
          vPlotElementPositions.push(calcHSV_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "hsv"),true,i,2,(i - 1)));
        }
    }
  ...
  for (var i = 0; i < globalCMS1.getKeyLength(); i++) {
    ...
    switch (globalCMS1.getKeyType(i)) {
      ...
      case "twin key":
        ...
        ////////////////////////////////////////////////////////////////
        /////// left Color
        pathplotElementPositions.push(calcLab_Hue_ElementPos(globalCMS1.getLeftKeyColor(i, "lab_rgb_possible"),drawCircle,i,0));

        ////////////////////////////////////////////////////////////////
        /////// Right Color
        pathplotElementPositions.push(calcLab_Hue_ElementPos(globalCMS1.getRightKeyColor(i, "lab_rgb_possible"),true,i,1));

        ////////////////////////////////////////////////////////////////
        /////// V Plot

        if (drawCircle) {
          vPlotElementPositions.push(calcLab_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "lab_rgb_possible"),true,i,0,i));
          vPlotElementPositions.push(calcLab_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "lab_rgb_possible"),true,i,1,i));
        } else {

          vPlotElementPositions.push(calcLab_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "lab_rgb_possible"),drawCircle,i,0,(i - 1)));
          vPlotElementPositions.push(calcLab_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "lab_rgb_possible"),drawCircle,i,0,i));
          vPlotElementPositions.push(calcLab_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "lab_rgb_possible"),true,i,1,i));
      ...
      default:
        // dual Key
        pathplotElementPositions.push(calcLab_Hue_ElementPos(globalCMS1.getRightKeyColor(i, "lab_rgb_possible"),true,i,2));

        ////////////////////////////////////////////////////////////////
        /////// V Plot
        vPlotElementPositions.push(calcLab_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "lab_rgb_possible"),true,i,2,i));
        if(globalCMS1.getKeyType(i-1)==="left key"){
          vPlotElementPositions.push(calcLab_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "lab_rgb_possible"),true,i,2,(i - 1)));
        }
    }
  ...
  for (var i = 0; i < globalCMS1.getKeyLength(); i++) {
    ...
    switch (globalCMS1.getKeyType(i)) {
      ...
      case "twin key":
        ...
        ////////////////////////////////////////////////////////////////
        /////// left Color
        pathplotElementPositions.push(calcDIN99_Hue_ElementPos(globalCMS1.getLeftKeyColor(i, "din99_rgb_possible"),drawCircle,i,0));

        ////////////////////////////////////////////////////////////////
        /////// Right Color
        pathplotElementPositions.push(calcDIN99_Hue_ElementPos(globalCMS1.getRightKeyColor(i, "din99_rgb_possible"),true,i,1));

        ////////////////////////////////////////////////////////////////
        /////// V Plot

        if (drawCircle) {
          vPlotElementPositions.push(calcDIN99_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "din99_rgb_possible"),true,i,0,i));
          vPlotElementPositions.push(calcDIN99_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "din99_rgb_possible"),true,i,1,i));
        } else {

          vPlotElementPositions.push(calcDIN99_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "din99_rgb_possible"),drawCircle,i,0,(i - 1)));
          vPlotElementPositions.push(calcDIN99_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "din99_rgb_possible"),drawCircle,i,0,i));
          vPlotElementPositions.push(calcDIN99_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "din99_rgb_possible"),true,i,1,i));
      ...
      default:
        // dual Key
        pathplotElementPositions.push(calcDIN99_Hue_ElementPos(globalCMS1.getRightKeyColor(i, "din99_rgb_possible"),true,i,2));

        ////////////////////////////////////////////////////////////////
        /////// V Plot
        vPlotElementPositions.push(calcDIN99_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "din99_rgb_possible"),true,i,2,i));
        if(globalCMS1.getKeyType(i-1)==="left key"){
          vPlotElementPositions.push(calcDIN99_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "din99_rgb_possible"),true,i,2,(i - 1)));//calcDIN99_VPlot_ElementPos(tmpColor,drawCircle,i,2,(i - 1)));
        }
    }
  ...
  for (var i = 0; i < globalCMS1.getKeyLength(); i++) {
    ...
    switch (globalCMS1.getKeyType(i)) {
      ...
      case "twin key":
        ...
        ////////////////////////////////////////////////////////////////
        /////// left Color
        pathplotElementPositions.push(calcLCH_Hue_ElementPos(globalCMS1.getLeftKeyColor(i, "lch_rgb_possible"),drawCircle,i,0));

        ////////////////////////////////////////////////////////////////
        /////// Right Color
        pathplotElementPositions.push(calcLCH_Hue_ElementPos(globalCMS1.getRightKeyColor(i, "lch_rgb_possible"),true,i,1));

        ////////////////////////////////////////////////////////////////
        /////// V Plot

        if (drawCircle) {
          vPlotElementPositions.push(calcLCH_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "lch_rgb_possible"),true,i,0,i));
          vPlotElementPositions.push(calcLCH_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "lch_rgb_possible"),true,i,1,i));
        } else {
          vPlotElementPositions.push(calcLCH_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "lch_rgb_possible"),drawCircle,i,0,(i - 1)));
          vPlotElementPositions.push(calcLCH_VPlot_ElementPos(globalCMS1.getLeftKeyColor(i, "lch_rgb_possible"),drawCircle,i,0,i));
          vPlotElementPositions.push(calcLCH_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "lch_rgb_possible"),true,i,1,i));
        }
      ...
      default:
        // dual Key
        pathplotElementPositions.push(calcLCH_Hue_ElementPos(globalCMS1.getRightKeyColor(i, "lch_rgb_possible"),true,i,2));

        ////////////////////////////////////////////////////////////////
        /////// V Plot
        vPlotElementPositions.push(calcLCH_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "lch_rgb_possible"),true,i,2,i));

        if(globalCMS1.getKeyType(i-1)==="left key"){
          vPlotElementPositions.push(calcLCH_VPlot_ElementPos(globalCMS1.getRightKeyColor(i, "lch_rgb_possible"),true,i,2,(i - 1)));
        }
    }
...
function calcLCH_Hue_ElementPos(tmpColor,shape,keyindex,colorSide){
