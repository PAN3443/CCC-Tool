...
function openFctBowlShapedTest(tmpID){
...
function selectNewFctBowlShapedType(){
  ...
  for (var i = 0; i < fctTest_BowlShaped_Options.length; i++) {
    ...
    option.innerHTML = fctTest_BowlShaped_Options[i][0];
    document.getElementById("id_TestPage_FctSelection").add(option);

    if(fctTest_BowlShaped_Options[i][1] == fctTest_NewBowlShaped_Options[1])
      rememberID=i;
  }
  ...
  document.getElementById("id_TestPage_NewTest_I1").value= fctTest_NewBowlShaped_Options[2][0];
  document.getElementById("id_TestPage_NewTest_I2").value= fctTest_NewBowlShaped_Options[2][1];
  document.getElementById("id_TestPage_NewTest_I3").value= fctTest_NewBowlShaped_Options[2][2];
  document.getElementById("id_TestPage_NewTest_I4").value= fctTest_NewBowlShaped_Options[2][3];
...
function updateFctBowlShapedTestVariables(){
  ...
  fctTest_NewBowlShaped_Options[2][0]=xStart;
  fctTest_NewBowlShaped_Options[2][1]=xEnd;
  fctTest_NewBowlShaped_Options[2][2]=yStart;
  fctTest_NewBowlShaped_Options[2][3]=yEnd;
...
function updateBowlShapedFctSelection(){
  ...
  for (var j = 0; j < fctTest_BowlShaped_Options[selectedID][2].length; j++) {
    var tmpVal = fctTest_BowlShaped_Options[selectedID][2][j];
