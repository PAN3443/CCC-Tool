...
window.onload = function() {
  ...
  includeHTML();
    ...
    if (doWorker && window.Worker) {
      ...
      script.src = version_JS_FolderName+"/src/sections/edit/edit_elements/pathplot/worker/mainThread_listenerEvent_pathplot.js";
      ...
      script.src = version_JS_FolderName+"/src/sections/edit/edit_elements/pathplot/pp_background.js";
      document.head.appendChild(script);
    }
