function onSliderInputSmoothMin() {
  var value = document.getElementById("id_OptiPage_SmoothOpti_Local_DegreeMin")
    .value;
  var degree = parseInt(value * 180);

  document.getElementById(
    "id_OptiPage_LocalSmooth_DegreeMin_Display"
  ).innerHTML = degree + "&#xb0;";

  document.getElementById("id_OptiPage_LocalSmooth_DegreeMax_Min").innerHTML =
    degree + "&#xb0;";
...
function onSliderInputSmoothMax() {
  var value = document.getElementById("id_OptiPage_SmoothOpti_Local_DegreeMax")
    .value;
  var degree = parseInt(value * 180);
  document.getElementById(
    "id_OptiPage_LocalSmooth_DegreeMax_Display"
  ).innerHTML = degree + "&#xb0;";

  document.getElementById("id_OptiPage_LocalSmooth_DegreeMin_Max").innerHTML =
    degree + "&#xb0;";
...
function drawMinAngle() {
  ...
  const canvas = document.getElementById(
    "id_OptiPage_LocalSmooth_MinAngleCanvas"
  );
  canvas.width = 250;
  canvas.height = 250;
...
class class_Edit_Optimization_Section extends class_Edit_Basis_Section {
  ...
  changeInterpolationSpace() {
    var intSpace = document.getElementById(this.selectInterpolationSpaceID)
      .options[
      document.getElementById(this.selectInterpolationSpaceID).selectedIndex
    ].value;
  ...
  changeInterpolationType() {
    switch (
      document.getElementById(this.selectInterpolationTypeID).selectedIndex
    ) {
      case 0:
  ...
  showSection() {
    if (
      editSection.editCMS.getInterpolationSpace() === "hsv" ||
      editSection.editCMS.getInterpolationSpace() === "lch"
    ) {
      openAlert(
        "Your CMS use the HSV or LCH colorspace for interpolation. Please change the interpolation colorspace to a space, that works with cartesian coordinates."
      );
      return;
    }
    ...
    document.getElementById(
      "id_OptiPage_LocalSpeedOptimization"
    ).checked = false;
    document.getElementById(
      "id_OptiPage_GlobalSpeedOptimization"
    ).checked = false;
    document.getElementById(
      "id_OptiPage_LocalIntOrderOptimization"
    ).checked = false;
    document.getElementById(
      "id_OptiPage_GlobalIntOrderOptimization"
    ).checked = false;
    document.getElementById(
      "id_OptiPage_LocalLegOrderOptimization"
    ).checked = false;
    document.getElementById(
      "id_OptiPage_GlobalLegOrderOptimization"
    ).checked = false;
    document.getElementById(
      "id_OptiPage_LocalDisPowerOptimization"
    ).checked = false;
    document.getElementById(
      "id_OptiPage_GlobalDisPowerOptimization"
    ).checked = false;
    document.getElementById(
      "id_OptiPage_Local_SmoothOptimization"
    ).checked = false;
    document.getElementById(
      "id_OptiPage_Global_SmoothOptimization"
    ).checked = false;
    ...
    for (
      var i = 0;
      i < document.getElementById("id_OptiPage_SelectOptiSpace").options.length;
      i++
    ) {
      if (
        document.getElementById("id_OptiPage_SelectOptiSpace").options[i]
          .value === this.editCMS.getInterpolationSpace()
      ) {
        document.getElementById(
          "id_OptiPage_SelectOptiSpace"
        ).selectedIndex = i;
        break;
      }
    }
    ...
    document.getElementById("id_OptiPage_editWarning").style.visibility =
      "hidden";
  }

  changeOptiSpace() {
    var space = document.getElementById("id_OptiPage_SelectOptiSpace").options[
      document.getElementById("id_OptiPage_SelectOptiSpace").selectedIndex
    ].value;
    this.editCMS.setInterpolationSpace(space);
    this.editCMS_Foundation.setInterpolationSpace(space);
    document.getElementById(this.cmsInterpolationID).innerHTML =
      "Interpolation: " +
      space +
      " (" +
      this.editCMS.getInterpolationType() +
      ")";
    this.part_Pathplot.changePathPlotSpace();
    this.calcOptiCMS();
  }
  ...
  fillKeyCombobox(saveOldPosition) {
    var tmpStartID = document.getElementById("id_OptiPage_Optimization_FromKey")
      .selectedIndex;
    var tmpEndID = document.getElementById("id_OptiPage_Optimization_TillKey")
      .selectedIndex;
    ...
    document.getElementById(
      "id_OptiPage_Optimization_FromKey"
    ...
    document.getElementById("id_OptiPage_Optimization_TillKey").options[
      document.getElementById("id_OptiPage_Optimization_TillKey").options
        .length - 1
    ].selected = true;
    ...
    if (
      ...
      tmpStartID >= 0 &&
      tmpEndID >= 0 &&
      tmpStartID < this.editCMS.getKeyLength() &&
      tmpEndID < this.editCMS.getKeyLength()
    ) {
      document.getElementById(
        "id_OptiPage_Optimization_FromKey"
      ).selectedIndex = tmpStartID;
      document.getElementById(
        "id_OptiPage_Optimization_TillKey"
      ).selectedIndex = tmpEndID;
      this.updateKeyIndex();
    }
  }

  updateKeyIndex() {
    var startIndex = document.getElementById("id_OptiPage_Optimization_FromKey")
      .selectedIndex;
    var endIndex = document.getElementById("id_OptiPage_Optimization_TillKey")
      .selectedIndex;

    var options = document.getElementById("id_OptiPage_Optimization_FromKey")
      .options;
    ...
    options = document.getElementById("id_OptiPage_Optimization_TillKey")
      .options;
    for (var i = 0; i < options.length; i++) {
  ...
  saveCreateProcess() {
    ...
    document.getElementById(
      "id_OptiPage_SmoothOpti_Local_DegreeMax"
    ).value = 1.0;
    ...
    this.editCMS_Foundation.setCMSFromPackage(
      this.editCMS.createCMSInfoPackage()
    );
  ...
  acceptAndReplace() {
    if (this.somethingOptimized || this.somethingChanged) {
      editSection.editCMS.setCMSFromPackage(
        this.editCMS.createCMSInfoPackage()
      );
  ...
  showHelp(index) {
    for (var i = 0; i < this.helpIDs.length; i++) {
      document.getElementById(
        "id_OptiPage_Info_" + this.helpIDs[i]
      ).style.display = "none";
    }
    if (index != undefined && index < this.helpIDs.length)
      document.getElementById(
        "id_OptiPage_Info_" + this.helpIDs[index]
      ).style.display = "flex";
  }

  chooseOptimizationType(type) {
    document
      .getElementById("id_Select_Uniform_Opti")
      .classList.remove("class_TabRowButtonActive");
    document
      .getElementById("id_Select_IntOrder_Opti")
      .classList.remove("class_TabRowButtonActive");
    document
      .getElementById("id_Select_LegOrder_Opti")
      .classList.remove("class_TabRowButtonActive");
    document
      .getElementById("id_Select_DisPower_Opti")
      .classList.remove("class_TabRowButtonActive");
    document
      .getElementById("id_Select_Smoothness_Opti")
      .classList.remove("class_TabRowButtonActive");

    document
      .getElementById("id_Select_Uniform_Opti")
      .classList.add("class_TabRowButtonNotActive");
    document
      .getElementById("id_Select_IntOrder_Opti")
      .classList.add("class_TabRowButtonNotActive");
    document
    ...
    switch (type) {
      case 0:
        document
          .getElementById("id_Select_Uniform_Opti")
          .classList.remove("class_TabRowButtonNotActive");
        document
          .getElementById("id_Select_Uniform_Opti")
          .classList.add("class_TabRowButtonActive");
        document.getElementById("id_Opti_Uniformity_Div").style.display =
          "block";
        break;
      case 1:
        document
  ...
  updateOptiPageStyle() {
    ...
    if (
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_LocalSpeedOptimization").checked
      ) {
        document.getElementById(
          "id_OptiPage_UniOpti_Local_Options"
        ).style.display = "block";
      } else {
        document.getElementById(
          "id_OptiPage_UniOpti_Local_Options"
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_GlobalSpeedOptimization").checked
      ) {
        document.getElementById("id_OptiPage_UniOpti_FixedDiv").style.display =
          "none";
        document.getElementById(
          "id_OptiPage_UniOpti_GraphSettings"
        ).style.display = "none";

        document.getElementById(
          "id_OptiPage_UniOpti_Global_Options"
        ).style.display = "block";

        if (document.getElementById("id_OptiPage_GlobalLinearReg").checked)
          document.getElementById(
            "id_OptiPage_UniOpti_FixedDiv"
          ).style.display = "block";
        else
          document.getElementById(
            "id_OptiPage_UniOpti_GraphSettings"
    ...
    if (
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_LocalIntOrderOptimization").checked
      ) {
        document.getElementById(
          "id_OptiPage_IntOrderOpti_Local_Options"
        ).style.display = "block";
      } else {
        document.getElementById(
          "id_OptiPage_IntOrderOpti_Local_Options"
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_GlobalIntOrderOptimization")
          .checked
      ) {
        document.getElementById(
          "id_OptiPage_IntOrderOpti_Global_Options"
        ).style.display = "block";
      } else {
        document.getElementById(
          "id_OptiPage_IntOrderOpti_Global_Options"
    ...
    if (
      ...
      if (document.getElementById("id_OptiPage_LegOrderUseDistance").checked) {
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Local_Label"
        ).innerHTML = "Distance";
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Global_Label"
        ).innerHTML = "Distance";
      } else {
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Local_Label"
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_LocalLegOrderOptimization").checked
      ) {
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Local_Options"
        ).style.display = "block";
      } else {
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Local_Options"
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_GlobalLegOrderOptimization")
          .checked
      ) {
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Global_Options"
        ).style.display = "block";
      } else {
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Global_Options"
    ...
    if (
      ...
      if (document.getElementById("id_OptiPage_DisPowerUseDistance").checked) {
        document.getElementById(
          "id_OptiPage_DisPowerOpti_Local_Label"
        ).innerHTML = "Distance";
        document.getElementById(
          "id_OptiPage_DisPowerOpti_Global_Label"
        ).innerHTML = "Distance";
      } else {
        document.getElementById(
          "id_OptiPage_DisPowerOpti_Local_Label"
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_LocalDisPowerOptimization").checked
      ) {
        document.getElementById(
          "id_OptiPage_DisPowerOpti_Local_Options"
        ).style.display = "block";
      } else {
        document.getElementById(
          "id_OptiPage_DisPowerOpti_Local_Options"
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_GlobalDisPowerOptimization")
          .checked
      ) {
        document.getElementById(
          "id_OptiPage_DisPowerOpti_Global_Options"
        ).style.display = "block";
      } else {
        document.getElementById(
          "id_OptiPage_DisPowerOpti_Global_Options"
    ...
    if (document.getElementById("id_Opti_Smooth_Div").style.display != "none") {
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_Local_SmoothOptimization").checked
      ) {
        document.getElementById(
          "id_OptiPage_SmoothOpti_Local_Options"
        ).style.display = "block";
      } else {
        document.getElementById(
          "id_OptiPage_SmoothOpti_Local_Options"
      ...
      //////////////////////////////////////////////////////////////
      if (
        document.getElementById("id_OptiPage_Global_SmoothOptimization").checked
      ) {
        document.getElementById(
          "id_OptiPage_SmoothOpti_Global_Options"
        ).style.display = "block";
      } else {
        document.getElementById(
          "id_OptiPage_SmoothOpti_Global_Options"
  ...
  updateLegendOptiWarningArea() {
    ...
    var distance = Math.abs(
      this.editCMS.getRefPosition(this.editCMS.getKeyLength() - 1) -
        this.editCMS.getRefPosition(0)
    );
    ...
    if (document.getElementById("id_OptiPage_LegOrderUseDistance").checked) {
      document.getElementById(
        "id_OptiPage_LegOrderOpti_Local_SpeedDisplay"
      ).innerHTML =
        blackWhiteDistance *
        document.getElementById("id_OptiPage_LegOrderOpti_Local_Speed").value;
      document.getElementById(
        "id_OptiPage_LegOrderOpti_Global_SpeedDisplay"
      ).innerHTML =
        blackWhiteDistance *
        document.getElementById("id_OptiPage_LegOrderOpti_Global_Speed").value;
      var smallestNoticeableArea = smallestNoticeableDelta / blackWhiteDistance;
      ///////////////////////////////////////////////////////
      ///// Not Noticeable Area
      document.getElementById(
        "id_OptiPage_LegOrderOpti_Local_NotNoticeableArea"
      ).style.width = smallestNoticeableArea * 100 + "%";
      document.getElementById(
        "id_OptiPage_LegOrderOpti_Global_NotNoticeableArea"
      ).style.width = smallestNoticeableArea * 100 + "%";
      ...
      if (
        smallesDistanceInOriginal_Local != Infinity &&
        smallesDistanceInOriginal_Local > smallestNoticeable
      ) {
        var smallestDistancePos =
          smallesDistanceInOriginal_Local / blackWhiteDistance;
        remainingNoChange = smallestDistancePos - smallestNoticeableArea;
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Local_NoChangeArea"
        ).style.width = remainingNoChange * 100 + "%";
        ...
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Info"
        ).style.visibility = "hidden";
      }

      var remainingFitable = 1.0 - smallestNoticeableArea - remainingNoChange;
      document.getElementById(
        "id_OptiPage_LegOrderOpti_Local_OkayArea"
      ).style.width = remainingFitable * 100 + "%";

      remainingNoChange = 0;
      if (
        smallesDistanceInOriginal_Global != Infinity &&
        smallesDistanceInOriginal_Global > smallestNoticeable
      ) {
        var smallestDistancePos =
          smallesDistanceInOriginal_Global / blackWhiteDistance;
        remainingNoChange = smallestDistancePos - smallestNoticeableArea;
        document.getElementById(
          "id_OptiPage_LegOrderOpti_Global_NoChangeArea"
        ).style.width = remainingNoChange * 100 + "%";
        //document.getElementById("id_OptiPage_LegOrderOpti_Info").style.visibility="visible";
      } else {
        ///////////////////////////////////////////////////////
      ...
      var remainingFitable = 1.0 - smallestNoticeableArea - remainingNoChange;
      document.getElementById(
        "id_OptiPage_LegOrderOpti_Global_OkayArea"
      ).style.width = remainingFitable * 100 + "%";
    } else {
      document.getElementById(
        "id_OptiPage_LegOrderOpti_Local_SpeedDisplay"
      ...
      var remainingNoChange = 0;
      if (
        smallesSpeedInOriginal_Local != Infinity &&
        smallesSpeedInOriginal_Local > smallestNoticeable
      ) {
      ...
      remainingNoChange = 0;
      if (
        smallesSpeedInOriginal_Global != Infinity &&
        smallesSpeedInOriginal_Global > smallestNoticeable
      ) {
  ...
  calcOptiCMS() {
    this.editCMS.setCMSFromPackage(
      this.editCMS_Foundation.createCMSInfoPackage()
    );
    this.somethingOptimized = false;
    /////////////////////////////////////////////////////////////////////////////////////
    ...
    if (
      ...
      var degree = document.getElementById(
        "id_OptiPage_IntOrderOpti_Local_Degree"
      ).value;
      var inserted = false;
      if (degree != 0) {
    ...
    if (
      document.getElementById("id_OptiPage_GlobalIntOrderOptimization").checked
    ) {
      var degree = document.getElementById(
        "id_OptiPage_IntOrderOpti_Global_Degree"
      ).value;
      var inserted = false;
      if (degree != 0) {
    ...
    if (
      ...
      var degree = document.getElementById(
        "id_OptiPage_LegOrderOpti_Local_Degree"
      ).value;
      var inserted = false;
      if (degree != 0) {
        for (var i = 0; i < optiLocalDegree.length; i++) {
    ...
    if (
      document.getElementById("id_OptiPage_GlobalLegOrderOptimization").checked
    ) {
      var degree = document.getElementById(
        "id_OptiPage_LegOrderOpti_Global_Degree"
      ).value;
      var inserted = false;
      if (degree != 0) {
        for (var i = 0; i < optiGlobalDegree.length; i++) {
    ...
    if (
      ...
      document.getElementById(
        "id_OptiPage_DisPowerOpti_Local_SpeedDisplay"
      ).innerHTML =
        this.optiGraph.determineMaxSetting(false) *
        document.getElementById("id_OptiPage_LegOrderOpti_Local_Speed").value;
      var degree = document.getElementById(
        "id_OptiPage_DisPowerOpti_Local_Degree"
      ).value;
      var inserted = false;
      if (degree != 0) {
        for (var i = 0; i < optiLocalDegree.length; i++) {
    ...
    if (
      document.getElementById("id_OptiPage_GlobalDisPowerOptimization").checked
    ) {
      document.getElementById(
        "id_OptiPage_DisPowerOpti_Global_SpeedDisplay"
      ).innerHTML =
        this.optiGraph.determineMaxSetting(true) *
        document.getElementById("id_OptiPage_LegOrderOpti_Global_Speed").value;
      var degree = document.getElementById(
        "id_OptiPage_DisPowerOpti_Global_Degree"
      ).value;
      var inserted = false;
    ...
    if (document.getElementById("id_OptiPage_LocalSpeedOptimization").checked) {
      var degree = document.getElementById("id_OptiPage_UniOpti_Local_Degree")
        .value;
      var inserted = false;
      if (degree != 0) {
        for (var i = 0; i < optiLocalDegree.length; i++) {
    ...
    if (
      ...
      var degree = document.getElementById("id_OptiPage_UniOpti_Global_Degree")
        .value;
      var inserted = false;
    ...
    if (
      ...
      var degree = document.getElementById(
        "id_OptiPage_SmoothOpti_Local_DegreeMin"
      ).value;

      var degree2 = document.getElementById(
        "id_OptiPage_SmoothOpti_Local_DegreeMax"
      ).value;
    ...
    if (
      ...
      var degree = document.getElementById(
        "id_OptiPage_SmoothOpti_Global_Degree"
      ).value;
      var inserted = false;
      ...
      for (var i = 0; i < optiGlobalType.length; i++) {
        ...
        switch (optiGlobalType[i]) {
          case 3:
            ...
            if (
              document.getElementById("id_OptiPage_GlobalLinearReg").checked
            ) {
    ...
    document.getElementById(
      "id_OptiPage_OptimizationExOrderGlobal"
    ).innerHTML = text;
    ...
    document.getElementById(
      "id_OptiPage_OptimizationExOrderLocal"
    ).innerHTML = text;
  ...
  optiGraphToCMS() {
    ...
    for (var i = 0; i < this.optiGraph.getNodeLength(); i++) {
      ...
      switch (tmpKeyInfo[1]) {
        case 0:
          this.editCMS.setLeftKeyColor(
            tmpKeyInfo[0],
            this.optiGraph.getNodeColor(i)
          );
          break;
        case 1:
          this.editCMS.setRightKeyColor(
            tmpKeyInfo[0],
            this.optiGraph.getNodeColor(i)
          );
          break;
  ...
  updateOptimizationCMS(optiDegree) {
    this.editCMS_Optimized.setCMSFromPackage(
      this.editCMS.createCMSInfoPackage()
    );

    for (
      var i = document.getElementById("id_OptiPage_Optimization_FromKey")
        .selectedIndex;
      i <=
      document.getElementById("id_OptiPage_Optimization_TillKey").selectedIndex;
      i++
    ) {
      if (
        i !=
          document.getElementById("id_OptiPage_Optimization_FromKey")
            .selectedIndex ||
        i !=
          document.getElementById("id_OptiPage_Optimization_TillKey")
            .selectedIndex
      ) {
      ...
      /////////////////////////////////////////////////////////////////
      ///// Left Color
      var original_LeftColor = this.editCMS_Foundation.getLeftKeyColor(
        i,
        this.editCMS_Foundation.getInterpolationSpace()
      );
      var opti_LeftColor = this.editCMS_Optimized.getLeftKeyColor(
        i,
        this.editCMS_Foundation.getInterpolationSpace()
      );
      if (original_LeftColor != undefined && opti_LeftColor != undefined) {
        ...
        if (!gWorkColor1.equalTo(opti_LeftColor)) {
          ...
          this.editCMS.setLeftKeyColor(i, [
            this.editCMS_Foundation.getInterpolationSpace(),
            newVal1,
            newVal2,
            newVal3,
      ...
      /////////////////////////////////////////////////////////////////
      ///// Right Color
      var original_RightColor = this.editCMS_Foundation.getRightKeyColor(
        i,
        this.editCMS_Foundation.getInterpolationSpace()
      );
      var opti_RightColor = this.editCMS_Optimized.getRightKeyColor(
        i,
        this.editCMS_Foundation.getInterpolationSpace()
      );
      ...
      if (original_RightColor != undefined && opti_RightColor != undefined) {
        ...
        if (!gWorkColor1.equalTo(opti_RightColor)) {
          ...
          this.editCMS.setRightKeyColor(i, [
            this.editCMS_Foundation.getInterpolationSpace(),
            newVal1,
            newVal2,
            newVal3,
  ...
  calcLocalUniformityOptimum() {
    var r1 = this.editCMS.getRefPosition(
      document.getElementById("id_OptiPage_Optimization_FromKey").selectedIndex
    );
    var r2 = this.editCMS.getRefPosition(
      document.getElementById("id_OptiPage_Optimization_TillKey").selectedIndex
    );
    ...
    for (
      ...
      if (
        this.editCMS.getKeyType(i) === "nil key" ||
        this.editCMS.getKeyType(i) === "left key"
      ) {
        bandsDeltaArray.push(undefined);
        var constBandDis = Math.abs(
          this.editCMS.getRefPosition(i + 1) - this.editCMS.getRefPosition(i)
        );
        relevantDistance -= constBandDis;
        contBandsDistances.push(constBandDis);
      } else {
        var c1 = this.editCMS.getRightKeyColor(
          i,
          this.editCMS.getInterpolationSpace()
        );
        var c2 = this.editCMS.getLeftKeyColor(
          i + 1,
          this.editCMS.getInterpolationSpace()
        );
        ...
        if (
          ...
          switch (this.editCMS.getInterpolationSpace()) {
            ...
            case "lab":
            case "din99":
              tmpDeltaSum += calc3DEuclideanDistance(
                c1,
                this.editCMS.getSupportColor(
                  i,
                  0,
                  this.editCMS.getInterpolationSpace()
                )
              ...
              for (
                var j = 0;
                j < this.editCMS.getSupportColorsLength(i) - 1;
                j++
              ) {
                tmpDeltaSum += calc3DEuclideanDistance(
                  this.editCMS.getSupportColor(
              ...
              tmpDeltaSum += calc3DEuclideanDistance(
                this.editCMS.getSupportColor(
                  i,
                  this.editCMS.getSupportColorsLength(i) - 1,
                  this.editCMS.getInterpolationSpace()
                ),
                c2
              );
            ...
            case "de2000":
            case "de2000-ds":
              tmpDeltaSum += calcDeltaCIEDE2000(
                c1,
                this.editCMS.getSupportColor(
                  i,
                  0,
  ...
  calcGlobalUniformityLinearRegOptimum() {
    var fixedStartKey = document.getElementById(
      "id_OptiPage_UniOpti_FixedStart"
    ).checked;
    var fixedEndKey = document.getElementById("id_OptiPage_UniOpti_FixedEnd")
      .checked;
    var continuousSections = this.editCMS.searchForContinuousSections(
      document.getElementById("id_OptiPage_Optimization_FromKey").selectedIndex,
      document.getElementById("id_OptiPage_Optimization_TillKey").selectedIndex
    );
    ...
    for (var i = 0; i < continuousSections.length; i++) {
      this.linearRegression(
        continuousSections[i][0],
        continuousSections[i][1],
        fixedStartKey,
        fixedEndKey
      );
    }
    ...
    if (
      this.editCMS.getInterpolationSpace() != "lab" &&
      this.editCMS.getInterpolationSpace() != "din99"
    )
      this.calcLocalUniformityOptimum();
  }
  ...
  linearRegression(startKey, endKey, fixedStartKey, fixedEndKey) {
    ...
    if (fixedStartKey && fixedEndKey) {
      var lineStartColor = this.editCMS.getRightKeyColor(
        startKey,
        this.editCMS.getInterpolationSpace()
      );
      var endStartColor = this.editCMS.getLeftKeyColor(
        endKey,
        this.editCMS.getInterpolationSpace()
      );
      ...
      for (var j = startKey + 1; j < endKey; j++) {
        ...
        var newColor = calcGradientLinear(
          lineStartColor[1],
          lineStartColor[2],
          lineStartColor[3],
          endStartColor[1],
      ...
      var tmpEnd = endKey;
      if (fixedStartKey) {
        fixedColor = this.editCMS.getRightKeyColor(
          startKey,
          this.editCMS.getInterpolationSpace()
        );
        //tmpStart++;
      } else {
        fixedColor = this.editCMS.getLeftKeyColor(
          endKey,
          this.editCMS.getInterpolationSpace()
        );
        //tmpEnd--;
      ...
      for (var i = tmpStart; i <= tmpEnd; i++) {
        ...
        if (i != endKey)
          tmpColor = this.editCMS.getRightKeyColor(
            i,
            this.editCMS.getInterpolationSpace()
          );
        else
          tmpColor = this.editCMS.getLeftKeyColor(
            endKey,
            this.editCMS.getInterpolationSpace()
          );
      ...
      for (var i = startKey; i <= endKey; i++) {
        var newVal1 =
          fixedColor[1] +
          closestLine_Parameter1 * this.editCMS.getRefPosition(i);
        var newVal2 =
          fixedColor[2] +
          closestLine_Parameter2 * this.editCMS.getRefPosition(i);
        var newVal3 =
          fixedColor[3] +
          closestLine_Parameter3 * this.editCMS.getRefPosition(i);
        newLineColors.push([
          this.editCMS.getInterpolationSpace(),
          newVal1,
          newVal2,
      ...
      /////////////////////////////////////////////////////////////
      var designMatrix_X_x_XT = matrixMultiplication(
        designMatrix_X_Transponse,
        designMatrix_X
      );
      var designMatrix_X_x_XT_Inverse = matrix_invert(designMatrix_X_x_XT);
      var designMatrix_Inverse_x_Transponse = matrixMultiplication(
        designMatrix_X_x_XT_Inverse,
        designMatrix_X_Transponse
      );
      ...
      var closestLine_Parameter1 = matrixVectorMultiplication(
        designMatrix_Inverse_x_Transponse,
        vector_y_val1
      );
      var closestLine_Parameter2 = matrixVectorMultiplication(
        designMatrix_Inverse_x_Transponse,
        vector_y_val2
      );
      var closestLine_Parameter3 = matrixVectorMultiplication(
        designMatrix_Inverse_x_Transponse,
        vector_y_val3
      );
      ...
      for (var i = startKey; i <= endKey; i++) {
        var newVal1 =
          closestLine_Parameter1[0] +
          closestLine_Parameter1[1] * this.editCMS.getRefPosition(i);
        var newVal2 =
          closestLine_Parameter2[0] +
          closestLine_Parameter2[1] * this.editCMS.getRefPosition(i);
        var newVal3 =
          closestLine_Parameter3[0] +
          closestLine_Parameter3[1] * this.editCMS.getRefPosition(i);
        newLineColors.push([
          this.editCMS.getInterpolationSpace(),
          newVal1,
          newVal2,
  ...
  calcGlobalUniformityForcedGraphOptimum(degree) {
    ...
    this.optiGraph = new class_Graph_ForcedGlobalSpeed(
      this.editCMS.getInterpolationSpace()
    );
    this.optiGraph.changeColorEdgeOptions(
      this.editCMS.getInterpolationSpace(),
      true,
      "eu"
    );
    ...
    var continuousSections = this.editCMS.searchForContinuousSections(
      0,
      this.editCMS.getKeyLength() - 1
    );

    for (var j = 0; j < continuousSections.length; j++) {
      if (continuousSections[j][0] < continuousSections[j][1]) {
        for (
          var i = continuousSections[j][0];
          i < continuousSections[j][1];
          i++
        ) {
          this.optiGraph.pushNode(
            this.editCMS.getRightKeyColor(
              i,
              this.editCMS.getInterpolationSpace()
            ),
            this.editCMS.getRefPosition(i)
          );
          if (
            i == continuousSections[j][0] &&
            (this.editCMS.getKeyType(i) === "right key" ||
              this.editCMS.getKeyType(i) === "twin key")
          )
            this.optiGraph.pushCMSInfo([i, 1]);
        ...
        this.optiGraph.pushNode(
          this.editCMS.getLeftKeyColor(
            continuousSections[j][1],
            this.editCMS.getInterpolationSpace()
          ),
          this.editCMS.getRefPosition(continuousSections[j][1])
        );
        if (
          this.editCMS.getKeyType(continuousSections[j][1]) === "left key" ||
          this.editCMS.getKeyType(continuousSections[j][1]) === "twin key"
        )
    ...
    //////////////////////////////////////////////////////////////////////////////
    this.optiGraph.forceLayout(
      document.getElementById("id_OptiPage_UniOpti_Iterations").value,
      degree
    );
    //////////////////////////////////////////////////////////////////////////////
    this.optiGraphToCMS();
  ...
  calcLocalIntOrderOptimum() {
    ...
    for (var j = 0; j < continuousSections.length; j++) {
      if (continuousSections[j][0] + 1 < continuousSections[j][1]) {
        for (
          var i = continuousSections[j][0] + 1;
          i < continuousSections[j][1];
          i++
        ) {
  ...
  calcGlobalIntOrderOptimum() {
    ...
    for (var j = 0; j < continuousSections.length; j++) {
      ...
      if (continuousSections[j][0] + 2 == continuousSections[j][1]) {
        this.calcOrderOptimumForKey(
          continuousSections[j][0],
          continuousSections[j][0] + 1,
          continuousSections[j][1]
        );
      } else {
        for (
          var k0 = continuousSections[j][0];
          k0 < continuousSections[j][1] - 1;
          k0++
        ) {
  ...
  calc3ColorOrderOptimum(color_K0, color_K1, color_K2) {
    ...
    if (orderVals[3] < 0 && orderVals[4] < 0) {
      ...
      var intersectionPoints1 = this.getLineSphereIntersection(
        color_K1,
        color_K0,
        color_K0,
        orderVals[0]
      );
      var intersectionPoints2 = this.getLineSphereIntersection(
        color_K1,
        color_K2,
        color_K2,
        orderVals[0]
      ...
      var tmpOrder1 = getOrderValues(
        color_K0,
        intersectionPoints1[0],
        color_K2,
        this.editCMS.getInterpolationSpace()
      );
      var tmpOrder2 = getOrderValues(
        color_K0,
        intersectionPoints1[1],
        color_K2,
        this.editCMS.getInterpolationSpace()
      );
      var tmpOrder3 = getOrderValues(
        color_K0,
        intersectionPoints2[0],
        color_K2,
        this.editCMS.getInterpolationSpace()
      );
      var tmpOrder4 = getOrderValues(
        color_K0,
        intersectionPoints2[1],
        color_K2,
        this.editCMS.getInterpolationSpace()
      );
      ...
      switch (counter) {
        ...
        case 2:
          ...
          if (isOrder1)
            dis_1_K1_Int = calc3DEuclideanDistance(
              color_K1,
              intersectionPoints1[0]
            );
          else
          ...
          if (isOrder3)
            dis_2_K1_Int = calc3DEuclideanDistance(
              color_K1,
              intersectionPoints2[0]
            );
          else
        ...
        default:
          ...
          var direction = [
            color_K2[1] - color_K0[1],
            color_K2[2] - color_K0[2],
            color_K2[3] - color_K0[3],
          ];

          var middle = [
            color_K0[1] + 0.5 * direction[0],
          ...
          var nA =
            norm[0] * middle[0] + norm[1] * middle[1] + norm[2] * middle[2];
          ...
          var divider =
            Math.pow(norm[0], 2) + Math.pow(norm[1], 2) + Math.pow(norm[2], 2);
          if (divider == 0) {
            return [0];
          }
          var tmp =
          ...
          var height =
            (calc3DEuclideanDistance(color_K0, color_K2) / 2) * Math.sqrt(3);

          var direction_MI = [
            intersection[0] - middle[0],
      ...
      if (orderVals[3] < 0) {
        ...
        intersectionPoints = this.getLineSphereIntersection(
          color_K1,
          color_K0,
          color_K0,
          orderVals[0]
  ...
  getLineSphereIntersection(colorL1, colorL2, colorCenter, radius) {
    ...
    var v_a =
      Math.pow(colorL2[1] - colorL1[1], 2) +
      Math.pow(colorL2[2] - colorL1[2], 2) +
      Math.pow(colorL2[3] - colorL1[3], 2);
    var v_b =
      -2 *
      ((colorL2[1] - colorL1[1]) * (colorCenter[1] - colorL1[1]) +
        (colorL2[2] - colorL1[2]) * (colorCenter[2] - colorL1[2]) +
        (colorL2[3] - colorL1[3]) * (colorCenter[3] - colorL1[3]));
    var v_c =
      Math.pow(colorCenter[1] - colorL1[1], 2) +
      Math.pow(colorCenter[2] - colorL1[2], 2) +
      Math.pow(colorCenter[3] - colorL1[3], 2) -
      Math.pow(radius, 2);
    ...
    if (v_D > 0) {
      ...
      var intColor1 = this.determineIntersectionPoint(
        colorL1,
        colorL2,
        val_t_pos
      );
      var intColor2 = this.determineIntersectionPoint(
        colorL1,
        colorL2,
        val_t_neg
      );
  ...
  createLegendBasedGraph() {
    ...
    switch (true) {
      case document.getElementById("id_OptiPage_DisPowerUseSpeed").checked:
        this.optiGraph = new class_Graph_ForcedLegOrder_Speed(
          optiSpace,
          document.getElementById(
            "id_OptiPage_GlobalLegOrderOptimization"
          ).checked
      ...
      case document.getElementById("id_OptiPage_DisPowerUseDistance").checked:
        this.optiGraph = new class_Graph_ForcedLegOrder_Distance(
          optiSpace,
          document.getElementById(
            "id_OptiPage_GlobalLegOrderOptimization"
          ).checked
    ...
    for (var i = 0; i < firstID; i++) {
      switch (this.editCMS.getKeyType(i)) {
        case "dual key":
          this.optiGraph.pushNode(
            this.editCMS.getRightKeyColor(i, optiSpace),
            this.editCMS.getRefPosition(i),
            true,
            i,
            2
        ...
        case "left key":
          this.optiGraph.pushNode(
            this.editCMS.getLeftKeyColor(i, optiSpace),
            this.editCMS.getRefPosition(i),
            true,
            i,
            0
    ...
    for (var j = 0; j < continuousSections.length; j++) {
      for (
        ...
        this.optiGraph.pushEdge(
          this.optiGraph.getNodeLength() - 1,
          this.optiGraph.getNodeLength()
        );
      } // for
      ...
      if (
        ...
        this.optiGraph.pushNode(
          this.editCMS.getLeftKeyColor(continuousSections[j][1], optiSpace),
          this.editCMS.getRefPosition(continuousSections[j][1]),
          false,
          continuousSections[j][1],
          0
  ...
  calcLegOrderOptimum(isGlobal, degree) {
      ...
      case document.getElementById("id_OptiPage_DisPowerUseSpeed").checked:
        ...
        switch (this.editCMS.getInterpolationSpace()) {
          case "rgb":
            ...
            var rgbWhite = ["rgb", 1, 1, 1];
            blackWhiteSpeed =
              calc3DEuclideanDistance(rgbBlack, rgbWhite) / distance; //
            break;
          case "hsv":
    ...
    if (isGlobal) {
      optiValue =
        ...
        document.getElementById("id_OptiPage_LegOrderOpti_Global_Speed").value;
      this.optiGraph.forceLayout(
        document.getElementById("id_OptiPage_LegOrderOpti_Global_Iterations")
          .value,
        degree,
        optiValue,
        isGlobal
      ...
      optiValue =
        ...
        document.getElementById("id_OptiPage_LegOrderOpti_Local_Speed").value;
      this.optiGraph.forceLayout(
        document.getElementById("id_OptiPage_LegOrderOpti_Local_Iterations")
          .value,
        degree,
        optiValue,
        isGlobal
  ...
  calcDisPowerOptimum(isGlobal, degree) {
    ...
    if (isGlobal)
      this.optiGraph.forceLayout(
        document.getElementById("id_OptiPage_DisPowerOpti_Global_Iterations")
          .value,
        document.getElementById("id_OptiPage_DisPowerOpti_Global_Speed").value,
        degree,
        isGlobal
      );
    else
      this.optiGraph.forceLayout(
        document.getElementById("id_OptiPage_DisPowerOpti_Local_Iterations")
          .value,
        document.getElementById("id_OptiPage_DisPowerOpti_Local_Speed").value,
        degree,
        isGlobal
      );
  ...
  calcLocalSmoothOptimum() {
    ...
    var idealAngleMin = parseInt(
      180 *
        document.getElementById("id_OptiPage_SmoothOpti_Local_DegreeMin").value
    );
    var idealAngleMax = parseInt(
      180 *
        document.getElementById("id_OptiPage_SmoothOpti_Local_DegreeMax").value
    );
    ...
    for (var j = 0; j < continuousSections.length; j++) {
      ...
      for (
        ...
        tmpArray.push(
          this.editCMS.getLeftKeyColor(i, this.editCMS.getInterpolationSpace())
        );
    ...
    var counter = 0;
    var interations = parseInt(
      document.getElementById("id_OptiPage_SmoothOpti_Local_Iterations").value
    );

    if (isNaN(interations)) {
      document.getElementById(
        "id_OptiPage_SmoothOpti_Local_Iterations"
      ).value = 20;
      interations = 20;
    }
          ...
          for (var i = 1; i < continuousSections_Colors[j].length - 1; i++) {
            var vec1 = [
              continuousSections_Colors[j][i - 1][1] -
                continuousSections_Colors[j][i][1],
              continuousSections_Colors[j][i - 1][2] -
                continuousSections_Colors[j][i][2],
              continuousSections_Colors[j][i - 1][3] -
                continuousSections_Colors[j][i][3],
            ];
            var vec2 = [
              continuousSections_Colors[j][i + 1][1] -
                continuousSections_Colors[j][i][1],
            ...
            var angle = rad2deg(
              Math.acos(
                vec_Dot(vec1, vec2) / (vecLength(vec1) * vecLength(vec2))
              )
            );
    ...
    for (var j = 0; j < continuousSections.length; j++) {
      ...
      for (
        ...
        this.editCMS.setRightKeyColor(
          i,
          continuousSections_Colors[j][i - continuousSections[j][0]]
        );
        this.editCMS.setLeftKeyColor(
          i,
          continuousSections_Colors[j][i - continuousSections[j][0]]
      ...
      this.editCMS.setLeftKeyColor(
        continuousSections[j][1],
        continuousSections_Colors[j][continuousSections_Colors[j].length - 1]
      );
    }
  }
}
