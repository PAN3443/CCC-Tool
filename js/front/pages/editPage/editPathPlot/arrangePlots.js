...
document.getElementById("id_editPage_PathPlotSpaces_DIN99").style.background = 'none';
  ...
  var rect =  document.getElementById("id_EditPage_PathPlot_Container").getBoundingClientRect();
  var rect2 = document.getElementById("id_EditPage_PathPlot_Canvas1_Label").getBoundingClientRect();
  ...
  if(type==0){
    ...
    var possibleCanvasHeight = (rect.height-(rect2.height*2))/2;
    ...
    document.getElementById("id_EditPage_PathPlot_3D_Div").style.height = canvasDim+"px";
    document.getElementById("id_EditPage_PathPlot_3D_Div").style.width = canvasDim+"px";
    document.getElementById("id_EditPage_PathPlot_Canvas1_Div").style.height = canvasDim+"px";
    document.getElementById("id_EditPage_PathPlot_Canvas1_Div").style.width = canvasDim+"px";
    document.getElementById("id_EditPage_PathPlot_Canvas2_Div").style.height = canvasDim+"px";
    document.getElementById("id_EditPage_PathPlot_Canvas2_Div").style.width = canvasDim+"px";
    document.getElementById("id_EditPage_PathPlot_Canvas3_Div").style.height = canvasDim+"px";
    document.getElementById("id_EditPage_PathPlot_Canvas3_Div").style.width = canvasDim+"px";
