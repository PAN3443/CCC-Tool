...
function changeOneSideFunction(type){
  ...
  switch (type){
    case 0:
        document.getElementById("id_EditPage_FunctionOneSided_Selection1").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editFunctionOneSided_Selection1").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
      ...
      break;
    case 1:
        document.getElementById("id_EditPage_FunctionOneSided_Selection2").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editFunctionOneSided_Selection2").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editProbeFunction_ValLabel").innerHTML="Value (0%,100%)";
        document.getElementById("id_EditPage_editProbeFunction_SatLabel").innerHTML="Saturation /";
      break;
      case 2:
          document.getElementById("id_EditPage_FunctionOneSided_Selection3").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
          document.getElementById("id_EditPage_editFunctionOneSided_Selection3").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        ...
        break;
        case 3:
            document.getElementById("id_EditPage_FunctionOneSided_Selection4").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
            document.getElementById("id_EditPage_editFunctionOneSided_Selection4").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
            document.getElementById("id_EditPage_editProbeFunction_ValLabel").innerHTML="Value /";
            document.getElementById("id_EditPage_editProbeFunction_SatLabel").innerHTML="Saturation (0%,100%)";
          break;
    default:
...
function changeTwoSideFunction(type){
  ...
  switch (type){
    case 0:
        document.getElementById("id_EditPage_FunctionTwoSided_Selection0").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editFunctionTwoSided_Selection0").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editProbeFunction_ValLabel").innerHTML="Value (0%,100%)";
        document.getElementById("id_EditPage_editProbeFunction_SatLabel").innerHTML="Saturation (0%,100%,0%)";
      break;
    case 1:
        document.getElementById("id_EditPage_FunctionTwoSided_Selection1").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editFunctionTwoSided_Selection1").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editProbeFunction_ValLabel").innerHTML="Value (100%,0%)";
        document.getElementById("id_EditPage_editProbeFunction_SatLabel").innerHTML="Saturation (0%,100%,0%)";
      break;
    case 2:
        document.getElementById("id_EditPage_FunctionTwoSided_Selection2").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editFunctionTwoSided_Selection2").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editProbeFunction_ValLabel").innerHTML="Value (100%,0%,100%)";
        document.getElementById("id_EditPage_editProbeFunction_SatLabel").innerHTML="Saturation (0%,100%)";
    break;
    case 3:
        document.getElementById("id_EditPage_FunctionTwoSided_Selection3").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editFunctionTwoSided_Selection3").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editProbeFunction_ValLabel").innerHTML="Value (100%,0%,100%)";
        document.getElementById("id_EditPage_editProbeFunction_SatLabel").innerHTML="Saturation (100%,0%)";
    break;
    case 4:
        document.getElementById("id_EditPage_FunctionTwoSided_Selection4").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editFunctionTwoSided_Selection4").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editProbeFunction_ValLabel").innerHTML="Value (0%,100%,0%)";
        document.getElementById("id_EditPage_editProbeFunction_SatLabel").innerHTML="Saturation (0%,100%)";
    break;
    case 5:
        document.getElementById("id_EditPage_FunctionTwoSided_Selection5").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editFunctionTwoSided_Selection5").style.background=getComputedStyle(document.documentElement).getPropertyValue('--general-active-color');
        document.getElementById("id_EditPage_editProbeFunction_ValLabel").innerHTML="Value (0%,100%,0%)";
        document.getElementById("id_EditPage_editProbeFunction_SatLabel").innerHTML="Saturation (100%,0%)";
    break;
    default:
