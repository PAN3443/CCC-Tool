...
function exportSide_createXML(workCMS){
    ...
    switch(exportColorspace) {
            case "rgb":
                xmltext = xmltext+"RGB";
                txtNaN="<NaN r=\""+workCMS.getNaNColor("rgb").get1Value()*scaleExpVal1+"\" g=\""+workCMS.getNaNColor("rgb").get2Value()*scaleExpVal2+"\" b=\""+workCMS.getNaNColor("rgb").get3Value()*scaleExpVal3+"\"/>\n";
                txtAbove="<Above r=\""+workCMS.getAboveColor("rgb").get1Value()*scaleExpVal1+"\" g=\""+workCMS.getAboveColor("rgb").get2Value()*scaleExpVal2+"\" b=\""+workCMS.getAboveColor("rgb").get3Value()*scaleExpVal3+"\"/>\n";
                txtBelow="<Below r=\""+workCMS.getBelowColor("rgb").get1Value()*scaleExpVal1+"\" g=\""+workCMS.getBelowColor("rgb").get2Value()*scaleExpVal2+"\" b=\""+workCMS.getBelowColor("rgb").get3Value()*scaleExpVal3+"\"/>\n";
                break;
            case "hsv":
                xmltext = xmltext+"HSV";
                txtNaN="<NaN h=\""+workCMS.getNaNColor("hsv").get1Value()*scaleExpVal1+"\" s=\""+workCMS.getNaNColor("hsv").get2Value()*scaleExpVal2+"\" v=\""+workCMS.getNaNColor("hsv").get3Value()*scaleExpVal3+"\"/>\n";
                txtAbove="<Above h=\""+workCMS.getAboveColor("hsv").get1Value()*scaleExpVal1+"\" s=\""+workCMS.getAboveColor("hsv").get2Value()*scaleExpVal2+"\" v=\""+workCMS.getAboveColor("hsv").get3Value()*scaleExpVal3+"\"/>\n";
                txtBelow="<Below h=\""+workCMS.getBelowColor("hsv").get1Value()*scaleExpVal1+"\" s=\""+workCMS.getBelowColor("hsv").get2Value()*scaleExpVal2+"\" v=\""+workCMS.getBelowColor("hsv").get3Value()*scaleExpVal3+"\"/>\n";
                break;
            case "lab":
                xmltext = xmltext+"LAB";
            ...
            case "lch":
                xmltext = xmltext+"LCH";
                txtNaN="<NaN l=\""+workCMS.getNaNColor("lch").get1Value()*scaleExpVal1+"\" c=\""+workCMS.getNaNColor("lch").get2Value()*scaleExpVal2+"\" h=\""+workCMS.getNaNColor("lch").get3Value()*scaleExpVal3+"\"/>\n";
                txtAbove="<Above l=\""+workCMS.getAboveColor("lch").get1Value()*scaleExpVal1+"\" c=\""+workCMS.getAboveColor("lch").get2Value()*scaleExpVal2+"\" h=\""+workCMS.getAboveColor("lch").get3Value()*scaleExpVal3+"\"/>\n";
                txtBelow="<Below l=\""+workCMS.getBelowColor("lch").get1Value()*scaleExpVal1+"\" c=\""+workCMS.getBelowColor("lch").get2Value()*scaleExpVal2+"\" h=\""+workCMS.getBelowColor("lch").get3Value()*scaleExpVal3+"\"/>\n";
                break;
            case "din99":
...
function exportSide_createJSON(workCMS){
    ...
    var tmpColor = workCMS.getAboveColor(exportColorspace);
    jsontext = jsontext+ tmpColor.get1Value()*scaleExpVal1 +","+tmpColor.get2Value()*scaleExpVal2+","+tmpColor.get3Value()*scaleExpVal3+"],\n\t\t\"BelowColor\" : [";
    var tmpColor = workCMS.getBelowColor(exportColorspace);
    jsontext = jsontext+ tmpColor.get1Value()*scaleExpVal1 +","+tmpColor.get2Value()*scaleExpVal2+","+tmpColor.get3Value()*scaleExpVal3+"],\n\t\t";
    switch(exportColorspace) {
            case "rgb":
